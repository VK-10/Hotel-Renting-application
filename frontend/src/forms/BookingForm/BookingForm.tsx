    ...
    return (
        ...
        className="grid grid-cols-1 gap-5 rounded-lg border border-slate-300 p-5">
            ...
            <div className="space-y-2">
                ...
                <CardElement id = "payment-element" className="border rounded-md p-2 textsm"/>
            </div>
            <div className="flex justify-end">
                <button type = "submit" className="bg-blue-600 text-white p-2 font-bold hover:bg-blue-500 text-md disabled:gray-500"
                disabled = {isPending}
                >
